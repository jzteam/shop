...
<html>
  <head>
    ...
    <title>My JSP 'updateInform.jsp' starting page</title>
  ...
  <tr>
    ...
    <table>
    	<tr>
    		<td>公告ID:</td>
    		<td><input type="text" value="${inform.informId}" name="informId"/></td>
    	</tr>
    	<tr>
    		<td>标题:</td>
    		<td><input type="text" value="${inform.informTitle}"/></td>
    	</tr>
    	<tr>
    		<td class="content">内容:</td>
    		<td>
    			<textarea rows="10" cols="20" name="informContent">${inform.informContent}</textarea>
    		</td>
    	</tr>
    	<tr>
