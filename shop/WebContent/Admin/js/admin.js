...
function manageAdmin(self) {
	var manageAdmin = document.getElementById("manageAdmin");
	manageAdmin.style.display = manageAdmin.style.display == "none" ? "block" : "none";
	if (manageAdmin.style.display == "none") {
		self.src = "Admin/images/manageAdminDown.jpg";
	} else {
		self.src = "Admin/images/manageAdminUp.jpg";
	}
}