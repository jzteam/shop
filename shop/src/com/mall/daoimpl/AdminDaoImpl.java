...
public class AdminDaoImpl implements AdminDao{
	...
	public boolean addAdmin(Admin admin) {
		...
		DbUtil dbUtil = null;
		String sql = "insert into tb_admin(AdminType,AdminName,LoginName,LoginPwd) values(?,?,?,?)";
		try {
			dbUtil = new DbUtil();
	...
	public Page doPage(int currentPage,int pageSize){
		...
		String sql = "select top "+pageSize+" * from tb_admin where Id not in (select top "+currentPage+" Id from tb_admin)";
