...
public class DeleteGoodsServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //获得用户 id集合
		String orders_str = request.getParameter("GoodsIds");
		//获得当前页号
		...
		if(model.deleteGoods(ids)) {
			request.getRequestDispatcher("getGoodsPagerServlet?pager.offset="+pageOffset+"&pageSize="+pageSize).forward(request, response);
		}
	}
