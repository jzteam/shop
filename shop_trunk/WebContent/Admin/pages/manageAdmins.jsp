...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" >
    	<tr>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">管理员ID</th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">真实姓名</th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">管理员级别<br></th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">登录名<br></th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">登录密码<br></th>
    	...
    	<form method="post" name="deleteForm">
	    	<c:forEach var="admin" items="${adminList}">
	    		<tr align="center">
	    			<td bgcolor="#FFFFFF" class="STYLE2">${admin.id }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${admin.adminName}</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${admin.adminType }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${admin.loginName }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${admin.loginPwd }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2"><input type="checkbox" name="delete" value="${admin.id }"></td>
	    			<td bgcolor="#FFFFFF" class="STYLE2"><a href="getOneAdminServlet?id=${admin.id}">详情</a></td>
	    		</tr>
	    	</c:forEach>
    	</form>
    </table>
