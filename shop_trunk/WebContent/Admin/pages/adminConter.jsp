		...
		<div id="left-column">
			...
			<div class="left-column-box">
				...
				<div id="manageProduct" style="display:none; ">
					<ul>
						<li><a href="allowAddSuperServlet" target="contentIframe" style="text-decoration:none; ">添加大类</a></li>
						<li><a href="allowAddSubServlet" target="contentIframe" style="text-decoration:none; ">添加小类</a></li>
						<li><a href="allowAddGoodsServlet" target="contentIframe" style="text-decoration:none; ">添加商品</a></li>
						<li><a href="getGoodsPagerServlet" target="contentIframe" style="text-decoration:none; ">查看商品</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
				<img class="left-column-title" src="Admin/images/manageAdminDown.jpg" onMouseDown="manageAdmin(this)"/>
				<div id="manageAdmin" style="display:none; ">
					<ul>
						<li><a href="getAdminPagerServlet" target="contentIframe" style="text-decoration:none; ">管理员</a></li>
						<li><a href="allowAddAdminServlet" target="contentIframe" style="text-decoration:none; ">添加管理员</a></li>
					</ul>
				</div>
			</div>
		</div>
    ...
    <td height="24" background="Admin/images/main_47.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="369"><span class="STYLE1">copyright &copy; </span></td>
