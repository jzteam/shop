  ...
  <head>
	...
	<script type="text/javascript">
		...
		function removeOrder(pageOffset,pageSize) {
			...
			oform.action = "deleteFreezeOrderServlet?orderIds="+orders+"&pageOffset="+pageOffset+"&pageSize="+pageSize;
			oform.submit();
		}
	</script>
  </head>
...
<td height="29"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="Admin/images/tab_21.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           <td>
    			 <pg:pager items="${orderPager.totalNum }" maxPageItems="${orderPager.pageSize}" export="currentPageNo = pageNumber" url="getOrderFreezePagerServlet">
