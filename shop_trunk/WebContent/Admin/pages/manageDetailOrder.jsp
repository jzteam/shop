  ...
  <tr>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
    	<tr>
    		...
    		<th background="Admin/images/tab_14.gif" class="STYLE1">订单项ID</th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">商品号</th>
    	...
    	<c:forEach var="orderItem" items="${order.orderItem}">
    		<tr>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.orderItemId }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.goodsId }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.goodsName }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.price}</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.goodsNum}</td>
    		</tr>
    	</c:forEach>
    </table>
    </td>
