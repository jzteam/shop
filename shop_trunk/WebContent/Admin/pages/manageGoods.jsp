...
<html>
  ...
  <tr>
	...
	<div align="left">按商品名查询:<input type="text" id="GoodsName" name="GoodsName" >
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" >
    	...
    	<c:forEach var="Goods" items="${ GoodsList}">
    		<tr>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2"><a href="updateGoodServlet?GoodsId=${Goods.goodsId}">详情</a></td>
    		</tr>
    	</c:forEach>
    	</form>
    </table>
