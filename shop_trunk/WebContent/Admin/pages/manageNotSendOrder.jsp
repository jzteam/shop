    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
    	...
    	<tr>
    		...
    		<th background="Admin/images/tab_14.gif">收获人姓名</th>
    		...
    		<td background="Admin/images/tab_14.gif">操作</td>
    	...
    	<c:forEach var="order" items="${ orderList}">
    		<tr>
    			...
    			<td bgcolor="#FFFFFF" class="STYLE2"><a href="adminSendOrderServlet?orderId=${order.orderId}&pageOffset=${orderPager.pageOffset}&pageSize=${orderPager.pageSize}">发货</a></td>
    			<td bgcolor="#FFFFFF" class="STYLE2"><a href="getOneOrderServlet?orderId=${order.orderId}">详情</a></td>
    		</c:forEach>
    		</tr>
    	
    	    <td> <font size=6 color=red>${sendMessage}</font></td>
    	</form>
    </table>
