    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
    	...
    	<c:forEach var="inform" items="${informList}">
    		<tr>
    			<td bgcolor="#FFFFFF" class="STYLE2">${inform.informId }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${inform.informTitle }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2" width="100px">${inform.informTime }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2"><textarea rows="4" cols="40">${inform.informContent }</textarea></td>
    			<td bgcolor="#FFFFFF" class="STYLE2"><input type="checkbox" name="delete" value="${inform.informId }"></td>	
    		</tr>
    	</c:forEach>
    	</form>
    </table>
