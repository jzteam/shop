    	...
    	<form method="post" name="deleteForm">
	    	<c:forEach var="user" items="${userList}">
	    		<tr align="center">
	    			...
	    			<td bgcolor="#FFFFFF" class="STYLE2">${user.sex }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${user.mphone }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${user.address }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2">${user.score }</td>
	    			<td bgcolor="#FFFFFF" class="STYLE2"><input type="checkbox" name="delete" value="${user.id }"></td>
	    			<td bgcolor="#FFFFFF" class="STYLE2"><a href="getOneUserServlet?id=${user.id}">详情</a></td>
	    		</tr>
	    	</c:forEach>
    	</form>
    </table>
        ...
        <td background="Admin/images/tab_21.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           <td align="center">
    		...
    		<input type="button" value="删除" onclick="removeUser(${userPager.pageOffset},${userPager.pageSize})">
    		</td>
