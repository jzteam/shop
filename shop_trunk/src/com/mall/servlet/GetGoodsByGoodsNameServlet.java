...
public class GetGoodsByGoodsNameServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (GoodsName_str != null) {
            ...
            String GoodsName = GoodsName_str;
            ...
            // GoodsPager.getGoodsMap().values());
            // request.getRequestDispatcher("Admin/pages/manageGoods.jsp").forward(request,
            // response);

            ResultJsonUtil.success(response, GoodsPager);
        }
    }
