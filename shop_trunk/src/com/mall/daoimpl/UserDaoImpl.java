...
public class UserDaoImpl implements UserDao {
    ...
    public Page doPage(int currentPage, int pageSize) {
        ...
        String sql = "select top " + pageSize + " * from tb_user where ID not in (select top " + currentPage
                + " ID from tb_user) ";
    ...
    public Page doNotePage(int currentPage, int pageSize) {
        ...
        String sql = "select top " + pageSize + " * from tb_note where id not in " + "(select top " + currentPage
                + " id from tb_note ) order by ly_time desc";
    ...
    public boolean addNote(Note note) {
        ...
        PreparedStatement pstmt = null;
        DbUtil dbUtil = null;
        String sql = "insert into tb_note(title,author,content,ly_time,imgs) values(?,?,?,getdate(),?)";
        try {
            dbUtil = new DbUtil();
            pstmt = dbUtil.getCon().prepareStatement(sql);
